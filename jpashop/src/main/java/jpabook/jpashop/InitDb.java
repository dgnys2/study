...
public class InitDb {
    ...
    static class InitService{
        ...
        public void dbInit2(){
            Member member = createMember("userB", "2");

            Book book1 = createBook("SECURITY1 BOOK", 20000, 200);

            Book book2 = createBook("SECURITY2 BOOK", 40000, 300);
        ...
        private Member createMember(String name, String street) {
